...
# MIGRATION CONTROLS
# =========================================================================
MIGRATION_LIMIT = None          # Set to None for all assets; 5 for a quick test
MIGRATE_ONLY_FIELDS = None   # None or [] = migrate all mapped fields
JIRA_SERIAL_ATTR_ID_OVERRIDE = None  # Leave None to use name-based lookup

# =========================================================================
# CACHES & MAPPING – root keys for standard fields
# =========================================================================
DEPARTMENT_CACHE = {}
LOCATION_CACHE = {}
USER_CACHE = {}
    ...
    try:
        ...
        while page <= max_pages:
            ...
            for asset in fs_assets:
                ...
                # Merge: root + type_fields + resolved
                fs_pool = {**asset, **type_fields, **resolved_references}

                serial_num = fs_pool.get("serial_number")
